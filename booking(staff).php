        ...
        <div class="container">
            ...
            <div class="section" id="bookedSection" style="display: none;">
                ...
                <div class="booked" id="booked">
                    <?php
                    $sql = "SELECT * FROM booking WHERE booking_confirmation = 'Confirm'";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td>
                                ...
                                <input type='hidden' name='booking_id' value='" . $row['booking_id'] . "'>
                                <input type='hidden' name='car_plate' value='" . $row['car_plate'] . "'>
                                <button type='submit' name='start' class='start' onclick='startMaintenance(booking_id,car_plate)'>Start</button>
                                </form>
                            </td>
                            </tr>";
                        }
